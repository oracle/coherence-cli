...
<pre>  -C, --cache-name string   cache name
  ...
  -I, --ignore-errors       ignore errors after initial refresh
      --ignore-special      ignore system caches or caches with $
...
<div class="admonition note">
<p class="admonition-inline">Added panels can be used by specifying the <code>-l</code> option in the <code>monitor cluster</code> command.</p>
</div>
