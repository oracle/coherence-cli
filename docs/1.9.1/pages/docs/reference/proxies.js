...
<li>
<p><router-link to="#get-proxy-members" @click.native="this.scrollFix('#get-proxy-members')"><code>cohctl get proxy-members</code></router-link> - displays proxy members for a specific proxy server</p>
...
<h4 id="get-proxy-members">Get Proxy Members</h4>
<div class="section">
<p>The 'get proxy-members' command displays the list of Coherence*Extend proxy
servers for a service. You can specify '-o wide' to display addition information.</p>

<p><strong>Usage</strong></p>

<div class="listing">
<pre>  cohctl get proxy-members [flags]</pre>
</div>

<p><strong>Flags</strong></p>

<div class="listing">
<pre>  -h, --help   help for proxy-members</pre>
</div>
...
>cohctl get proxy-members Proxy -c local</markup>
...
4        0.0.0.0:60490.43677  Proxy                   1       8 MB      0 MB        15       20              0            0       0</markup>
...
>cohctl get proxy-connections Proxy -c local</markup>
...
>NODE ID    CONN MS  CONN TIME  REMOTE ADDR/PORT  BYTES SENT  BYTES REC  BACKLOG  CLIENT PROCESS  CLIENT ROLE
      ...
      2  1,177,423    19m 37s   127.0.0.1:58075        1 MB       0 MB        0           45646  TangosolCoherenceDslqueryQueryPlus</markup>
...
>cohctl get proxy-connections Proxy -o wide -c local</markup>
...
>NODE ID    CONN MS  CONN TIME  REMOTE ADDR/PORT  BYTES SENT  BYTES REC  BACKLOG  CLIENT PROCESS  CLIENT ROLE                         REMOTE MEMBER
      ...
      2  1,215,764    20m 15s   127.0.0.1:58075        1 MB       0 MB        0           45646  TangosolCoherenceDslqueryQueryPlus  Member(Id=0, Timest...</markup>
