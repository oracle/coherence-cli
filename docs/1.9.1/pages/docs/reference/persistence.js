...
<li>
<p><router-link to="#force-recovery" @click.native="this.scrollFix('#force-recovery')"><code>cohctl force recovery</code></router-link> -proceeds with persistence recovery despite the dynamic quorum policy objections</p>

</li>
</ul>

<p>See the <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/administer/persisting-caches.html">Coherence Documentation</a> for
...
See <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/administer/persisting-caches.html">the Coherence documentation</a>
for more details.</p>
</div>
...
<h4 id="force-recovery">Force Recovery</h4>
<div class="section">
<p>The 'force recovery' command proceeds with persistence recovery despite the dynamic quorum policy objections
This may lead to the partial or full data loss of the corresponding cache service.</p>

<p><strong>Usage</strong></p>

<div class="listing">
<pre>  cohctl force recovery service-name [flags]</pre>
</div>

<p><strong>Flags</strong></p>

<div class="listing">
<pre>  -h, --help   help for recovery
  -y, --yes    automatically confirm the operation</pre>
</div>
...
>cohctl force recovery PartitionedCache -c local</markup>
...
operation force recovery on service PartitionedCache invoked</markup>
...
<ul class="ulist">
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/administer/persisting-caches.html">Persisting Caches in the Coherence Documentation</a></p>
