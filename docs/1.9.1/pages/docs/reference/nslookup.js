...
<ul class="ulist">
<li>
<p><router-link to="#nslookup" @click.native="this.scrollFix('#nslookup')"><code>cohctl nslookup</code></router-link> - looks up various Name Service endpoints for a cluster host/port</p>
...
NameService/string/health/HTTPHealthURL and NameService/string/Cluster/foreign/&lt;clustername&gt;/NameService/localPort</p>
...
>cohctl nslookup -q Cluster/name</markup>
...
>cohctl nslookup -q Cluster/info localhost:7574</markup>
...
>cohctl nslookup -q NameService/string/Cluster/foreign</markup>
...
>cohctl nslookup -q NameService/string/management/HTTPManagementURL</markup>
...
>cohctl nslookup -q NameService/string/Cluster/foreign/cluster2/NameService/localPort</markup>
