...
<p class="admonition-inline">In the examples below, we are also using the <a target="_blank" href="https://github.com/stedolan/jq">jq</a> utility to format the JSON output.</p>
</div>
...
>cohctl describe cluster my-cluster -o jsonpath="$.cluster..['clusterName', 'version', 'clusterSize']"</markup>
...
>cohctl get services -o jsonpath="$.items[?(@.requestAverageDuration &gt; 10)]..['nodeId','name','requestAverageDuration']"  | jq</markup>
...
>cohctl get members -o jsonpath="$.items[?(@.memoryAvailableMB &lt; 250)]..['nodeId','memoryMaxMB','memoryAvailableMB']" | jq</markup>
...
>cohctl get caches -o jsonpath="$.items[?(@.totalPuts &gt; 10000)]..['service','name','totalPuts']" | jq</markup>
...
>cohctl get http-servers -o jsonpath="$.items[?(@.totalRequestCount &gt; 15)]..['nodeId','name','totalRequestCount']"</markup>
...
>cohctl get persistence -o jsonpath="$.items[?(@.persistenceLatencyAverage &gt; 0.020)]..['nodeId','name','persistenceLatencyAverage']" | jq</markup>
...
<ul class="ulist">
<li>
<p><a target="_blank" href="https://earthly.dev/blog/jq-select/">An Introduction to JQ</a></p>

</li>
<li>
<p><a target="_blank" href="https://goessner.net/articles/JsonPath/">JSONPath examples</a></p>
