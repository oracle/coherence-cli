...
<router-link to="/docs/installation/installation">Coherence CLI Installation section</router-link>.

</li>
<li>
You must have a Coherence cluster running that has Management over REST configured.
<div class="admonition note">
<p class="admonition-inline">See the <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/rest-reference/quick-start.html">Coherence Documentation</a>
...
>docker run -d -p 30000:30000 ghcr.io/oracle/coherence-ce:14.1.2-0-1</markup>
...
<div class="admonition note">
<p class="admonition-inline">If you are connecting to WebLogic Server then see the <router-link to="/docs/reference/clusters">Clusters Command Reference</router-link> for more information on the connection requirements.</p>
</div>
...
These options are explained in detail in <router-link to="/docs/config/global_flags">Global Flags</router-link>.</p>
...
Available Commands:
  ...
  force       force recovery for a persistence service
  get         display one or many resources
  help        Help about any command
  log         log a resource
  monitor     monitor one or many resources
...
Flags:
  ...
  -o, --output string           output format: table, wide, json or jsonpath="..." (default "table")
      --percent-bar             show percentage as bar
      --percent-bar-width int   set percentage bar width (default 30)
...
local       http  http://localhost:30000/management/coherence/cluster  14.1.2-0-1    my-cluster    Standalone         false</markup>
...
>cohctl describe service PartitionedCache</markup>
...
<div class="admonition note">
<p class="admonition-inline">You can also use the <code>-W</code> option which will clear the screen between displaying data.</p>
</div>
...
>cohctl get members -o json | jq</markup>
...
>cohctl get services -o jsonpath="$.items[?(@.requestAverageDuration &gt; 15)]..['nodeId','name','requestAverageDuration']"</markup>
...
<p>See the <router-link to="/docs/examples/jsonpath">JSONPath</router-link> examples for more information.</p>
...
<div class="section">
<p>Explore more of the commands <router-link to="/docs/reference/overview">here</router-link>.</p>
