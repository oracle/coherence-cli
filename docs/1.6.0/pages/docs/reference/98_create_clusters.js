...
<li>
Java 17+ executable on the PATH, if you are using the default Coherence CE 22.06.7 version.
...
commercial 14.1.1.2206.1 and above. Default version is currently CE 22.06.7.
...
<pre>  -a, --additional string         additional comma separated Coherence artifacts or others in G:A:V format
  ...
  -v, --version string            cluster version (default "22.06.7")
...
<div class="admonition note">
<p class="admonition-inline">By default, Coherence CE groupId is used and the version is 22.06.7. You can change this via using <code>-C</code> for commercial and <code>-v</code> to change the Coherence version.</p>
</div>
<div class="admonition note">
...
- com.oracle.coherence.ce:coherence:22.06.7
- com.oracle.coherence.ce:coherence-json:22.06.7
- com.oracle.coherence.ce:coherence-rest:22.06.7
...
<div class="listing">
<pre>  -e, --health-port int32      starting port for health
  -M, --heap-memory string     heap memory to allocate for JVM if default-heap not set (default "128m")
  -h, --help                   help for cluster
  -l, --log-level int32        coherence log level (default 5)
  -t, --metrics-port int32     starting port for metrics
...
2022-08-29 16:00:01.346/0.620 Oracle Coherence 22.06.7 <Info> (thread=main, member=n/a): Loaded operational configuration from "jar:file:/Users/user/.m2/repository/com/oracle/coherence/ce/coherence/22.06.7/coherence-22.06.7.jar!/tangosol-coherence.xml"
...
