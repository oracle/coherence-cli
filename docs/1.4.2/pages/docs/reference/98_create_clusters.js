...
<li>
Java 17+ executable on the PATH, if you are using the default Coherence CE 22.09 version.
...
<p class="admonition-inline">If you wish to use an earlier version of Coherence such as CE 22.06, you can use JDK11+.</p>
</div>
<div class="admonition note">
...
<pre>  -a, --additional string         additional comma separated Coherence artifacts or others in G:A:V format
  ...
  -K, --skip-deps                 skip pulling artifacts
  -S, --start-class string        class name to start server with (default from Coherence version)
...
2022-08-29 16:00:01.346/0.620 Oracle Coherence 22.09 <Info> (thread=main, member=n/a): Loaded operational configuration from "jar:file:/Users/user/.m2/repository/com/oracle/coherence/ce/coherence/22.09/coherence-22.09.jar!/tangosol-coherence.xml"
...
