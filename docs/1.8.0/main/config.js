...
function createRoutes(){
    return [
        ...
        {
            path: '/docs/config/08_sorting_table_output',
            meta: {
            ...
            component: loadPage('docs-config-08_sorting_table_output', '/docs/config/08_sorting_table_output', {})
        },
        {
        ...
        {
            path: '/docs/config/20_using_proxy_servers',
            meta: {
            ...
            component: loadPage('docs-config-20_using_proxy_servers', '/docs/config/20_using_proxy_servers', {})
        },
        {
        ...
        {
            path: '/docs/reference/26_view_caches',
            meta: {
                h1: 'View Caches',
                title: 'View Caches',
                h1Prefix: null,
            ...
            component: loadPage('docs-reference-26_view_caches', '/docs/reference/26_view_caches', {})
        },
        {
        ...
        {
            path: '/docs/reference/99_monitor_clusters',
            meta: {
                h1: 'Monitor Clusters',
            ...
            component: loadPage('docs-reference-99_monitor_clusters', '/docs/reference/99_monitor_clusters', {})
        },
        {
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/docs/config/08_sorting_table_output', title: 'Sorting Table Output' },
                ...
                { href: '/docs/config/20_using_proxy_servers', title: 'Using Proxy Servers' }
            ]
        },
        {
            ...
            items: [
                ...
                { href: '/docs/reference/26_view_caches', title: 'View Caches' },
                ...
                { href: '/docs/reference/99_monitor_clusters', title: 'Monitor Clusters' }
            ]
        },
        {
            title: 'Security',
