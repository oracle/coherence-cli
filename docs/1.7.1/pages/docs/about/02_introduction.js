...
<p>To view the release notes for the latest version of the CLI (1.7.1), see <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-cli/releases">GitHub</a>.</p>
...
<li>
Create, start stop and scale local only development based clusters - <router-link to="/docs/reference/98_create_clusters">more information</router-link>.

</li>
<li>
Monitor clusters using a text based UI to show multiple panels - <router-link to="/docs/reference/99_monitor_clusters">more information</router-link>.
