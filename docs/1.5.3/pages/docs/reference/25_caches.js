...
<li>
<p><router-link to="#get-cache-storage" @click.native="this.scrollFix('#get-cache-storage')"><code>cohctl get cache-storage</code></router-link> - displays cache storage information for a cache and service</p>

</li>
<li>
<p><router-link to="#get-cache-access" @click.native="this.scrollFix('#get-cache-access')"><code>cohctl get cache-access</code></router-link> - displays cache access information for a cache and service</p>
