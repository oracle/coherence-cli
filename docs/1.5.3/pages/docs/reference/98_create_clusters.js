...
<li>
Java 17+ executable on the PATH, if you are using the default Coherence CE 22.06.6 version.
...
commercial 14.1.1.2206.1 and above. Default version is currently CE 22.06.6.
...
<pre>  -a, --additional string         additional comma separated Coherence artifacts or others in G:A:V format
  ...
  -v, --version string            cluster version (default "22.06.6")
...
>Cluster name:           local
Cluster version:        {coherence-default-version}
Cluster port:           7574
Partition count:        257
...
- com.oracle.coherence.ce:coherence:{coherence-default-version}
- com.oracle.coherence.ce:coherence-json:{coherence-default-version}
...
<div class="admonition note">
<p class="admonition-inline">By default, Coherence CE groupId is used and the version is 22.06.6. You can change this via using <code>-C</code> for commercial and <code>-v</code> to change the Coherence version.</p>
</div>
<div class="admonition note">
...
>cohctl create cluster local -C -v 14.1.1-2206-5 -M 1g -P active -S</markup>
...
- com.oracle.coherence.ce:coherence:22.06.6
- com.oracle.coherence.ce:coherence-json:22.06.6
- com.oracle.coherence.ce:coherence-rest:22.06.6
...
2022-08-29 16:00:01.346/0.620 Oracle Coherence 22.06.6 <Info> (thread=main, member=n/a): Loaded operational configuration from "jar:file:/Users/user/.m2/repository/com/oracle/coherence/ce/coherence/22.06.6/coherence-22.06.6.jar!/tangosol-coherence.xml"
...
