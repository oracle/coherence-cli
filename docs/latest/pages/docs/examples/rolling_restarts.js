...
our cluster. For more details on rolling restarts, please see <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/develop-applications/starting-and-stopping-cluster-members.html">Starting and Stopping Cluster Members</a> in the Coherence documentation.</p>
...
<div class="section">
<p>The <router-link :to="{path: '/docs/reference/health', hash: '#monitor-health'}">cohctl monitor health</router-link> command provides a different option to check for cluster health
if you have configured http health endpoints as described  <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/using-health-check-api.html">here</a>.</p>
...
<li>
<p><router-link to="/docs/reference/health">Health Commands</router-link></p>

</li>
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/develop-applications/starting-and-stopping-cluster-members.html">Starting and Stopping Cluster Members</a></p>

</li>
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/oracle-coherence-mbeans-reference.html">Coherence MBean Reference</a></p>

</li>
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/using-health-check-api.html">Coherence Health API</a></p>
