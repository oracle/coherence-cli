...
<li>
<p><router-link to="#start-class" @click.native="this.scrollFix('#start-class')"><code>cohctl start class</code></router-link> - starts a specific Java class against the local Coherence cluster</p>
...
<pre>  -a, --additional string         additional comma separated Coherence artifacts or others in G:A:V format
  ...
  -C, --commercial                use commercial Coherence groupID (default is CE)
  -M, --heap-memory string        heap memory to allocate for JVM if default-heap not set (default "512m")
  ...
  -S, --skip-deps                 skip pulling Maven artifacts
  -D, --startup-delay int32       startup delay in seconds for each server (default 1)
  -v, --version string            cluster version (default "22.09")
  -W, --wka string                well known address (default "127.0.0.1")
...
NODE ID  ADDRESS     PORT   PROCESS  MEMBER     ROLE             STORAGE  MAX HEAP  USED HEAP  AVAIL HEAP
      ...
      3  /127.0.0.1  49254    56174  storage-1  CoherenceServer  true       512 MB      70 MB      442 MB</markup>

<div class="admonition note">
<p class="admonition-inline">By default, Coherence CE groupId is used and the version is 22.09. You can change this via using <code>-C</code> for commercial and <code>-v</code> to change the Coherence version.</p>
</div>
<div class="admonition note">
...
<p>Add and start a commercial Coherence cluster (14.1.1.2206.1) and set initial memory for each cluster to 1g and use active persistence mode.</p>
...
<div class="admonition note">
<p class="admonition-inline">In this example we are using the <code>-S</code> option to skip downloading maven artifacts as we know they are already installed locally.</p>
</div>
...
- com.oracle.coherence.ce:coherence:22.09
- com.oracle.coherence.ce:coherence-json:22.09
- com.oracle.coherence.ce:coherence-rest:22.09
...
<div class="listing">
<pre>  -M, --heap-memory string    heap memory to allocate for JVM if default-heap not set (default "512m")
  -h, --help                  help for cluster
  -l, --log-level int32       coherence log level (default 5)
  -t, --metrics-port int32    starting port for metrics
  -P, --profile string        profile to add to cluster startup command line
...
<p>Start a cluster and specify heap size of <code>1g</code>. (default is 512m)</p>
...
<div class="section">
<p>The 'start console' command starts a console client against a cluster that was manually created.</p>
...
<div class="section">
<p>The 'start cohql' command starts a CohQL client against a cluster that was manually created.</p>
...
<div class="section">
<p>The 'start class' command starts a specific Java class against the local Coherence cluster.
The class name must include the full package and class name.</p>
...
<div class="admonition note">
<p class="admonition-inline">If no default-heap is set, then the default of 512m is used unless a value for <code>-M</code> is specified.</p>
</div>
</div>
