...
>cohctl get ignore-certs</markup>
...
<p>See the <router-link to="/docs/config/changing_config_locations">config</router-link> section for more details on changing the log file location.</p>
...
>cohctl get management -c local</markup>
...
>cohctl set management -a expiryDelay -v 5000 -c local</markup>
...
>cohctl set management -a refreshPolicy -v refresh-ahead -c local</markup>
...
>Are you sure you want to set the value of attribute refreshPolicy to refresh-ahead? (y/n) y</markup>
...
>cohctl get timeout -c local</markup>
...
>cohctl set timeout 15 -c local</markup>
