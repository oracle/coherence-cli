...
specify the full url such as <a target="_blank" href="https://&lt;host&gt;:&lt;management-port&gt;/management/coherence/cluster" class="bare">https://&lt;host&gt;:&lt;management-port&gt;/management/coherence/cluster</a>.
...
<ul class="ulist">
<li>
<p>Standalone Coherence - <a target="_blank" href="http://host:management-port/management/coherence/cluster" class="bare">http://host:management-port/management/coherence/cluster</a></p>

</li>
<li>
<p>WebLogic Server - <a target="_blank" href="http://&lt;admin-host&gt;:&lt;admin-port&gt;/management/coherence/latest/clusters" class="bare">http://&lt;admin-host&gt;:&lt;admin-port&gt;/management/coherence/latest/clusters</a></p>
...
local       http  http://localhost:30000/management/coherence/cluster  22.06.11  my-cluster    Standalone        false</markup>
...
<ul class="ulist">
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/rest-reference/quick-start.html">Setting up Management over REST</a></p>

</li>
<li>
<p><a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/secure/securing-oracle-oracle-http-management-rest-server.html">Securing Oracle Coherence HTTP Management Over REST Server</a></p>

</li>
<li>
<p><router-link to="/docs/reference/contexts">Contexts</router-link></p>

</li>
<li>
<p><router-link to="/docs/reference/nslookup">NS Lookup</router-link></p>

</li>
<li>
<p><router-link to="/docs/reference/create_clusters">Creating Development Clusters</router-link></p>
