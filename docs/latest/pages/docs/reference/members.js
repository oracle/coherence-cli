...
<div class="listing">
<pre>  -D, --departed      show departed members only
  -h, --help          help for members
  -M, --members       show members only
...
<p>Display all departed members.</p>

<markup
lang="bash"

>cohctl get members -c local -D</markup>
...
>NODE ID  TIMESTAMP                ADDRESS          MACHINE ID  LOCATION                                         ROLE
      ...
      4  2024-03-26 08:11:00.537  127.0.0.1:50250  10131       machine:localhost,process:6601,member:storage-4  CoherenceServer</markup>

<div class="admonition note">
<p class="admonition-inline">Members are displayed in descending order of departure time.</p>
</div>
...
>NODE ID  ADDRESS     PORT   PROCESS  MEMBER                         ROLE              PKT SENT  PKT REC  RESENT  EFFICIENCY  SEND Q  DATA SENT  DATA REC  WEAKEST
      ...
      4  /127.0.0.1  50968    81733  com.tangosol.net.CacheFactory  CoherenceConsole        64       58       0     100.00%       0       3 MB      0 MB        -</markup>
...
<div class="listing">
<pre>  -h, --help   help for p2p-stats</pre>
</div>
...
<ul class="ulist">
<li>
<p><router-link to="/docs/reference/diagnostics">Diagnostics</router-link></p>
