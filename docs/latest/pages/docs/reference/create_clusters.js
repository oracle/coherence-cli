...
<li>
Java 17+ executable on the PATH, if you are using the default Coherence CE 14.1.2-0-1 version.
...
<li>
<p><router-link to="#restart-cluster" @click.native="this.scrollFix('#restart-cluster')"><code>cohctl restart cluster</code></router-link> - restarts a cluster that was manually created or started</p>
...
commercial 14.1.1.2206.1 and above. Default version is currently CE 14.1.2-0-1.
...
<pre>  -a, --additional string         additional comma separated Coherence artifacts or others in G:A:V format
  ...
  -l, --log-level int32           coherence log level (default 5)
      --machine string            the machine name to use
      --maven-settings string     full path to Maven settings file
  ...
  -F, --profile-first             only apply profile to the first member starting
      --rack string               the rack name to use
  -r, --replicas int32            number of replicas (default 3)
      --role string               the role name to use
      --site string               the site name to use
  ...
  -v, --version string            cluster version (default "14.1.2-0-1")
...
- com.oracle.coherence.ce:coherence:14.1.2-0-1
- com.oracle.coherence.ce:coherence-json:14.1.2-0-1
...
<div class="admonition note">
<p class="admonition-inline">By default, Coherence CE groupId is used and the version is 14.1.2-0-1. You can change this via using <code>-C</code> for commercial and <code>-v</code> to change the Coherence version.</p>
</div>
...
- com.oracle.coherence.ce:coherence:14.1.2-0-1
- com.oracle.coherence.ce:coherence-json:14.1.2-0-1
- com.oracle.coherence.ce:coherence-rest:14.1.2-0-1
...
<div class="section">
<p>The 'restart cluster' command stops and restart a cluster that was manually created or started.</p>

<p><strong>Usage</strong></p>

<div class="listing">
<pre>  cohctl restart cluster [flags]</pre>
</div>
...
>cohctl restart cluster local -M 1g</markup>
...
2022-08-29 16:00:01.346/0.620 Oracle Coherence 14.1.2-0-1 <Info> (thread=main, member=n/a): Loaded operational configuration from "jar:file:/Users/user/.m2/repository/com/oracle/coherence/ce/coherence/14.1.2-0-1/coherence-14.1.2-0-1.jar!/tangosol-coherence.xml"
...
...
<pre>  -X, --extend               start CohQL as Extend client. Only works for default cache config
  ...
  -G, --grpc                 start CohQL as gRPC client. Only works for default cache config
  -M, --heap-memory string   heap memory to allocate for JVM if default-heap not set (default "128m")
...
which will be passed to the called class.</p>
...
<pre>  -X, --extend               start a class as Extend client. Only works for default cache config
  -G, --grpc                 start a class as gRPC client. Only works for default cache config
  -M, --heap-memory string   heap memory to allocate for JVM if default-heap not set (default "128m")
