...
<p>See <a target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/oracle-coherence-mbeans-reference.html">MBean Reference</a>
...
>cohctl get caches -c local</markup>
...
PartitionedCache  test   123,000  30 MB</markup>
...
>cohctl reset cache-stats test -s PartitionedCache -n 1,2 -c local</markup>
...
coherence-concurrent-default-executor             3            0          0         0  SingleThreaded(ThreadFactory=default)</markup>
...
>cohctl get federation all -c local</markup>
...
FederatedService  cluster2           1  [IDLE]       3 MB    13,873    30,000          0.0Mbps</markup>

<markup
lang="bash"

>cohctl reset federation-stats FederatedService -p cluster2 -T outgoing -c local</markup>
...
>cohctl reset ramjournal-stats -c local</markup>
...
>cohctl reset flashjournal-stats -c local</markup>
...
>cohctl get members -c local</markup>
...
NODE ID  ADDRESS     PORT   PROCESS  MEMBER     ROLE             STORAGE  MAX HEAP  USED HEAP  AVAIL HEAP
      ...
      3  /127.0.0.1  58941    96296  storage-1  CoherenceServer  true       128 MB      21 MB      107 MB</markup>

<markup
lang="bash"

>cohctl reset member-stats -n 1,3 -c local</markup>
...
>NODE ID  STATE    CONFIG FILE               OUTPUT PATH                       BATCH#  LAST REPORT  LAST RUN   AVG RUN  INTERVAL  AUTOSTART
      ...
      3  Stopped  reports/report-group.xml  /Users/user/Documents/Coheren...       0                    0ms  0.0000ms        60  false</markup>

<markup
lang="bash"

>cohctl reset reporter-stats -c local</markup>
...
"$SYS:Concurrent"       DistributedCache        3  NODE-SAFE        3         257</markup>

<markup
lang="bash"

>cohctl reset service-stats PartitionedCache -c local</markup>
...
>cohctl get proxies -c local</markup>
...
1        0.0.0.0:64073.41509  Proxy                         0       0 MB      0 MB</markup>
