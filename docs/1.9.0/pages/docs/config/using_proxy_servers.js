...
<p>The CLI honors the following standard environment variable settings, by internally using <a target="_blank" href="https://pkg.go.dev/net/http#ProxyFromEnvironment">Proxy.ProxyFromEnvironment</a>, for proxy server configuration:</p>
