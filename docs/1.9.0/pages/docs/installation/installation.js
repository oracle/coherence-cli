...
<p><strong>The latest version of the CLI is 1.9.0</strong>.</p>
...
<p>See <a target="_blank" href="https://github.com/oracle/coherence-cli/releases">here</a> for all supported platforms.</p>

<div class="admonition note">
<p class="admonition-inline">If there is a platform you would like included, please submit an issue <a target="_blank" href="https://github.com/oracle/coherence-cli/issues/new/choose">here</a>.</p>
</div>
...
Alternatively you can download the relevant exe from <a target="_blank" href="https://github.com/oracle/coherence-cli/releases">here</a>.</p>

<markup
lang="bash"

>curl -Lo cohctl.exe "https://github.com/oracle/coherence-cli/releases/download/1.9.0/cohctl-1.9.0-windows-amd64.exe"</markup>
...
you will find this off the users home directory. See <router-link to="/docs/config/changing_config_locations">here</router-link> for more information.</p>
