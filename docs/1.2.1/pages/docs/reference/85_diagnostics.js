...
<ul class="ulist">
<li>
<p><router-link to="#get-jfrs" @click.native="this.scrollFix('#get-jfrs')"><code>cohctl get jfrs</code></router-link> - displays the JFR&#8217;s for a cluster</p>
...
members and places them in the specified output directory'.</p>
...
<pre>  -D, --dump-delay int32    delay between each thread dump (default 10)
  ...
  -O, --output-dir string   existing directory to output thread dumps to
...
<pre>  -h, --help                   help for tracing
  ...
  -t, --tracingRatio float32   rracing ratio to set. -1.0 turns off tracing (default 1)
  -y, --yes                    automatically confirm the operation</pre>
</div>
...
<li>
<p><a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/debugging-coherence.html">Distributed Tracing in Coherence</a></p>
