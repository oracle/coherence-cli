...
<p><strong>The latest version of the CLI is 1.0.0-RC1</strong>.</p>
...
<ul class="ulist">
<li>
<p>Intel - <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-cli/releases/download/1.0.0-RC1/Oracle-Coherence-CLI-1.0.0-RC1-darwin-amd64.pkg">Oracle-Coherence-CLI-1.0.0-RC1-darwin-amd64.pkg</a></p>

</li>
<li>
<p>Apple Silicon - <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-cli/releases/download/1.0.0-RC1/Oracle-Coherence-CLI-1.0.0-RC1-darwin-arm64.pkg">Oracle-Coherence-CLI-1.0.0-RC1-darwin-arm64.pkg</a></p>

</li>
</ul>
<p>You can also use curl to download:</p>

<markup
lang="bash"

>curl -Lo cohctl "https://github.com/oracle/coherence-cli/releases/download/1.0.0-RC1/Oracle-Coherence-CLI-1.0.0-RC1-darwin-amd64.pkg"</markup>

<div class="admonition note">
<p class="admonition-inline">Change the <code>amd64</code> to <code>arm64</code> for ARM based (Apple Silicon) processor.</p>
</div>
<div class="admonition note">
...
>curl -Lo cohctl "https://github.com/oracle/coherence-cli/releases/download/1.0.0-RC1/cohctl-1.0.0-RC1-linux-amd64"
...
>curl -Lo cohctl.exe "https://github.com/oracle/coherence-cli/releases/download/1.0.0-RC1/cohctl-1.0.0-RC1-windows-amd64.exe"</markup>
