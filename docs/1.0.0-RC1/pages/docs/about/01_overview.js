...
<p></p>
<p>Introduction to the Coherence CLI.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/installation/01_installation"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-text class="caption">
<p></p>
<p>Installing the Coherence CLI for your platform.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-card-text class="caption">
<p></p>
<p>Quick start guide to getting started with the Coherence CLI.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Configuration</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/reference/01_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Command Reference</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Coherence CLI Command Reference.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/troubleshooting/01_trouble-shooting"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/examples/01_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-text class="caption">
<p></p>
<p>A number of examples on how get the most out of the Coherence CLI.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
