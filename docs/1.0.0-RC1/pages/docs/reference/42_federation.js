...
<li>
<p><router-link to="#stop-federation" @click.native="this.scrollFix('#stop-federation')"><code>cohctl stop federation</code></router-link> - stop federation for a service</p>

</li>
<li>
<p><router-link to="#pause-federation" @click.native="this.scrollFix('#pause-federation')"><code>cohctl pause federation</code></router-link> - pause federation for a service</p>
...
FederatedCache  secondary-cluster        2  [IDLE]      204MB     1,028     3,348          0.0Mbps      338ms         1,393ms           37,770ms    100.00%</markup>
