...
Cluster Heap - Total: 1,792MB, Used: 386MB, Available: 1,406MB (78.5%)
Storage Heap - Total: 1,536MB, Used: 315MB, Available: 1,221MB (79.5%)

NODE ID  ADDRESS        PORT   PROCESS  MEMBER  ROLE                  STORAGE  MAX HEAP  USED HEAP  AVAIL HEAP
      1  192.168.1.118  50999    85665  n/a     Management            true        512MB      162MB       350MB
      3  192.168.1.118  51004    85733  n/a     CoherenceConsole      false       256MB       71MB       185MB
      4  192.168.1.118  51000    85687  n/a     TangosolNetCoherence  true        512MB      114MB       398MB
      5  192.168.1.118  51644    88138  n/a     TangosolNetCoherence  true        512MB       39MB       473MB
----

NOTE: The default memory display format is `MB` but can be changed to `GB` by using `-u` or `--units` option.
...
NODE ID  ADDRESS          PORT  PROCESS  MEMBER  ROLE                 STORAGE  MAX HEAP  USED HEAP  AVAIL HEAP
1        192.168.1.124   53216    12096  n/a     CoherenceServer      true        512MB       95MB       929MB
