...
* <<get-jfrs, `cohctl get jfrs`>> - displays the JFR's for a cluster
...
NOTE: When taking thread dumps, if you want full deadlock analysis, you should set the following system property
...
* https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/debugging-coherence.html[Distributed Tracing in Coherence]
