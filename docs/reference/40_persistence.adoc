...
See the https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/administer/persisting-caches.html[Coherence Documentation] for
...
PartitionedCache               4  active                    6,331,471                6MB      0.242ms        188ms          2  Idle
----
...
filesystem available to all members.  You can also create your own archiver implementations. See https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/administer/persisting-caches.html[the Coherence documentation]
for more details.
...
* https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/administer/persisting-caches.html[Persisting Caches in the Coherence Documentation]
