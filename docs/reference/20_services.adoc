...
* <<get-services-storage, `cohctl get services-storage`>> - displays partitioned services storage information for a cluster
...
include::../../build/_output/docs-gen/get_services_storage.adoc[tag=text]

*Examples*

[source,bash]
----
$ cohctl get services-storage -c local
