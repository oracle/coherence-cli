...
1. Java 11+ executable on the classpath, or Java 17+ if you are using Coherence CE 22.09 or above.
2. Maven 3.6+ or Gradle 7.+ executable on the classpath.
...
Start a cluster and specify heap size of `1g`. (default is 256m)
...
NOTE: If no default-heap is set, then the default of 256m is used.
