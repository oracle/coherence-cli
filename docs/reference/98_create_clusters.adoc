...
1. Java 17+ executable on the PATH, if you are using the default Coherence CE {coherence-default-version} version.
...
* <<start-class, `cohctl start class`>> - starts a specific Java class against the local Coherence cluster
...
NOTE: By default, Coherence CE groupId is used and the version is {coherence-default-version}. You can change this via using `-C` for commercial and `-v` to change the Coherence version.
...
- com.oracle.coherence.ce:coherence:{coherence-default-version}
- com.oracle.coherence.ce:coherence-json:{coherence-default-version}
- com.oracle.coherence.ce:coherence-rest:{coherence-default-version}
...
2022-08-29 16:00:01.346/0.620 Oracle Coherence {coherence-default-version} <Info> (thread=main, member=n/a): Loaded operational configuration from "jar:file:/Users/user/.m2/repository/com/oracle/coherence/ce/coherence/{coherence-default-version}/coherence-{coherence-default-version}.jar!/tangosol-coherence.xml"
...
