...
1. Java 17+ executable on the classpath, if you are using the default Coherence CE 22.09 or above.
2. Maven 3.6+ or JDK compatible Gradle version 7.+ executable on the classpath.
