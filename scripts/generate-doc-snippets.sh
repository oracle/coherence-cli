...
create_doc $DOCS_DIR/get_federation_outgoing "${COHCTL} get federation-outgoing --help"
...
create_doc $DOCS_DIR/get_service_distributions "${COHCTL} get service-distributions --help"
...
create_doc $DOCS_DIR/get_cache_partitions "${COHCTL} get cache-partitions --help"
...
create_doc $DOCS_DIR/get_topic_channels "${COHCTL} get topic-channels --help"
